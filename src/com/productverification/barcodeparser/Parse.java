...
public class Parse {	
	...
	public static void main(String[] args){		
		...
		try {
			...
			for (BarcodeData data : BarcodeDatalist) {
				System.out.println("BarcodeDatalist :: dataTitle - "+ data.dataTitle +" | Ai - "+ data.ai +" | Data - "+ data.data);
			}
	...
	public List<BarcodeData> ParseBarcode(String barcode){
